    ...
    <div className="page-shell">
        ...
        <div className="brand">
          <span className="brand-mark" aria-hidden="true">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              ...
              />
              <path
                d="M6 10.5v5c0 .5 2.6 2.5 6 2.5s6-2 6-2.5v-5"
                stroke="currentColor"
                strokeWidth="1.6"
                strokeLinejoin="round"
              />
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p>
            Simply attach your rubric/question paper and student answer sheets. Our AI agent
            evaluates responses and provides a question-by-question breakdown.
          </p>
        </div>
        <div className="hero-snapshot">
          <div className="snapshot-card">
            ...
            <ol className="snapshot-steps">
              <li>Upload Rubric / Question Paper</li>
              <li>Upload Student Answer Sheet</li>
              <li>Review Score Feed</li>
              <li>Chat to adjust or clarify grades</li>
            </ol>
          </div>
        </div>
      </section>
          ...
          <section className="panel panel-results">
            ...
            <div className="result-summary">
              ...
              <p className="summary-text">
                {response
                  ? `Successfully evaluated ${questionList.length || 0} question${questionList.length === 1 ? "" : "s"}.`
          ...
          <section className="panel chat-panel">
            ...
            <div className="chat-window" ref={chatWindowRef}>
              {chatMessages.length === 0 ? (
                <p className="chat-placeholder">Ask follow-up questions or request grade adjustments…</p>
              ) : (
